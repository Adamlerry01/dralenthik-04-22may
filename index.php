...
_Hasync.push(['Histats.start', '1,5028212,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5028212&101" alt="histats" border="0"></a></noscript>
<!-- Histats.com  END  -->
          ...
          <div class="header-bottom offcanvas offcanvas-end " id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                ...
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="index.html">Blog</a>
                </li>
                <li class="nav-item px-3">
                ...
                <li class="nav-item px-3 dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                    ...
                    <li><a href="index.html" class="dropdown-item ">Room </a>
                    </li>
                    <li><a href="index.html" class="dropdown-item">Room-Details
                        </a></li>
                    ...
                    <li><a href="index.html" class="dropdown-item ">Service-Details
                        </a></li>
                    <li><a href="index.html" class="dropdown-item ">Booking </a></li>
                    <li><a href="index.html" class="dropdown-item ">Gallery </a></li>
                    <li><a href="index.html" class="dropdown-item ">Contact </a></li>
                    <li><a href="index.html" class="dropdown-item ">Team </a>
                    </li>
